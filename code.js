...
const colors = ["red","blue","orange","Pink","white","black"]
...
function loremSentences(){
    let numberOfSentences = document.getElementById("loreSentence").value
